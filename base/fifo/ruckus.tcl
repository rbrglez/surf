...
loadSource -lib -dir  "$::DIR_PATH/rtl/inferred"
loadSource -lib -path "$::DIR_PATH/rtl/dummy/FifoAlteraMfDummy.vhd"
...
if { $::env(VIVADO_VERSION) < 2019.1 } {
   # Load a dummy module
   loadSource -lib -path "$::DIR_PATH/rtl/dummy/FifoXpmDummy.vhd"
   ...
   # Load the wrapper
   loadSource -lib -path "$::DIR_PATH/rtl/xilinx/FifoXpm.vhd"
}
